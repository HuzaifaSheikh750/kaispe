          ...
          <div className="row">
            <div className="col-xxl-12">
              <div className="sec-title-wrapper">
                <h2 className="sec-sub-title title-anim">Our Implementation Methodology</h2>
                <p className="">KAISPE possess a solid implementation methodology to guide you to the finish line while making sure nothing gets overlooked. We have a customized implementation methodology that gets coupled with our industry-specific knowledge to bring the best value to customers.</p>
              </div>
            </div>
                ...
                <div className="swiper-wrapper">
                  <SwiperSlide>
                    <div className="workflow__slide fade_left">
                      ...
                      <h6 className="workflow__title">ANALYSIS</h6>
                  ...
                  <SwiperSlide>
                    <div className="workflow__slide fade_left">
                      ...
                      <h6 className="workflow__title">DEPLOYMENT</h6>
                      <p>
                  ...
                  <SwiperSlide>
                    <div className="workflow__slide fade_left">
                      ...
                      <h6 className="workflow__title">OPERATION</h6>
                      <p>
                        We look forward to engage with beyond the conventional
                      </p>
                    </div>
