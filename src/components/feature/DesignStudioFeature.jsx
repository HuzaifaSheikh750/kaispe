...
const DesignStudioFeature = () => {
  ...
  return (
    <>
      <section className="feature__area-2 pt-130" style={{marginBottom:"100px"}}>
            ...
            <div className="row">
              ...
              <div className="col-xxl-5 col-xl-5 col-lg-5 col-md-6">
                <div className="feature__text text-anim">
                  <p>
                    With our years of hands-on experience helping customers, we
                    understand that the upgrade projects are complex and so we
                    have been following the proven upgrade methodology with
                ...
                <div className="feature__list animation__feature2">
                  <div className="feature__item">
                    <Image
                      ...
                      alt="Feature Icon"
                    />
                    <h3 className="feature__title">Analyze</h3>
                  ...
                  <div className="feature__item">
                    <Image
                      ...
                      alt="Feature Icon"
                    />
                    <h3 className="feature__title">Execute</h3>
                    <p style={{textDecoration:"underline"}}>
                  ...
                  <div className="feature__item">
                    <Image
                      ...
                      alt="Feature Icon"
                    />
                    <h3 className="feature__title">Validate</h3>
                    <p style={{textDecoration:"underline"}}>
                  ...
                  <div className="feature__item">
                    <Image
                      ...
                      alt="Feature Icon"
                    />
                    <h3 className="feature__title">Go Live</h3>
                    <p style={{textDecoration:"underline"}}>
