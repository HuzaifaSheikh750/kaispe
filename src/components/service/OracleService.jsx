          ...
          <div className="row">
            <div className="col-xxl-5 col-xl-5 col-lg-6 col-md-6">
              <div className="service__left-6">
                ...
                Features and capabilities of Oracle NetSuite
                </h3>
              </div>
            </div>
            <div className="col-xxl-7 col-xl-7 col-lg-6 col-md-6">
              <div className="service__right-4">
                <p>
                  <span>Without delving into the specifics of all the various ERP suppliers, when you want to grow your organization, get NetSuite analytics, and it will become your best choice for life.</span>
                </p>
